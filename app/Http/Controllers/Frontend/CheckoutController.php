...
use App\Http\Services\ShipRocketApiService;
use App\Models\Cart;
use App\Models\City;
...
class CheckoutController extends Controller
{
    ...
    public function __construct(ShipRocketApiService $shippingService)
    {
    ...
    public function getLogistic(Request $request)
    {
        ...
        $logisticZoneCities = LogisticZoneCity::where('city_id', $request->city_id)->distinct('logistic_id')->get();
        $pinCodes = City::where('id', $request->city_id)->pluck('pin_code');
        // $pinCodes = City::where('id', $request->city_id)->pluck('pin_code');
        
        $pickup_postcode= '560001';
        $weight= 1000;
        $cod = false;
        $shippingCharge = $this->shippingService->calculateShippingCharge($pickup_postcode, $pinCodes[0], $weight, $cod);
        dd($shippingCharge, $pinCodes[0]);
        // dd($logisticZoneCities, $pinCodes);
        return [
